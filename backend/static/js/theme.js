...
export const THEMES = {
  // Agent Colette — graphite · turquoise · black · warcast (default)
  dark:       { bg:'#0e1114', fg:'#d4ddde', panel:'#161a1f', border:'#2a3338', red:'#2dd4bf',
                advanced: { brandColor: '#2dd4bf', sendBtnBg: '#2dd4bf', sendBtnHover: '#5eead4',
                            toggleActive: '#2dd4bf' } },
